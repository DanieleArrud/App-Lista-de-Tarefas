...
import { StyleSheet, ScrollView, Text, View, ImageBackground, TouchableOpacity, TouchableHighlight ,Modal ,TextInput } from 'react-native';
  ...
  useEffect(()=>{
    ...
    (async() =>{
      try{
        ...
        setarTarefas(JSON.perse(tarefasAtual));
      }catch(error){
        //Erro
      }
    })();
  ...
  return (
    ...
    <ScrollView style={{flex:1}}>
        ...
        >
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <TouchableHighlight style={{ ...styles.openButton, backgroundColor: "#010105"}} 
              onPress={() => addTarefa()}>
     ...
     <TouchableOpacity style={styles.btnAddTarefa} onPress={()=>setModal(true)}>
       <Text style={{textAlign:'center', padding: 10, color:'white'}}>Adicionar Tarefa</Text>
    </TouchableOpacity>
